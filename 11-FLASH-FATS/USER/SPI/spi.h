...
void SPI_FLASH_BufferRead(uint8_t *readbuffer,uint32_t addr,uint16_t numByteToRead);																			void SPI_Write_Data(uint32_t addr,uint8_t *writebuffer,uint32_t numByteToWrite);
